...
static void save_dialog_prefs(GKeyFile *config)
{
	...
	g_key_file_set_boolean(config, PACKAGE, "sidebar_projectfiles_visible", interface_prefs.sidebar_projectfiles_visible);
...
static void load_dialog_prefs(GKeyFile *config)
{
	...
	interface_prefs.sidebar_projectfiles_visible = utils_get_setting_boolean(config, PACKAGE, "sidebar_projectfiles_visible", TRUE);
