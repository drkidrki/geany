...
static void prepare_status_tree_view(void)
{
	...
	ui_tree_view_disable_overlay_scrollbar(GTK_TREE_VIEW(msgwindow.tree_status));
...
static void prepare_compiler_tree_view(void)
{
	...
	ui_tree_view_disable_overlay_scrollbar(GTK_TREE_VIEW(msgwindow.tree_compiler));
